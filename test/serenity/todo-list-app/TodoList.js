const { contain, Ensure, equals, includes, isGreaterThan } = require('@serenity-js/assertions')
const { Check, d, Task, Wait } = require('@serenity-js/core')
const { By, Enter, ExecuteScript, isVisible, Key, Navigate, Page, PageElement, PageElements, Press, Text } = require('@serenity-js/web')

const { TodoListItem } = require('./TodoListItem')

module.exports.TodoList = class TodoList {
    ...
    static createListContaining = (itemNames) =>
    ...
    static markAsCompleted = (itemNames) =>
    ...
    static markAsOutstanding = (itemNames) =>
